...
void protobuf_AssignDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto() {
  protobuf_AddDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "proto/dbproxy/dbproxy.Request.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto);
}
...
void protobuf_AddDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n#proto/dbproxy/dbproxy.Request.proto\022\rp"
    "roto_dbproxy\"\222\002\n\007Request\022\022\n\nidentifier\030\001"
    " \002(\r\0223\n\006dbtype\030\002 \002(\0162#.proto_dbproxy.Req"
    "uest.DatabaseType\0221\n\006action\030\003 \002(\0162!.prot"
    "o_dbproxy.Request.ActoinType\022\016\n\006dbname\030\004"
    " \002(\t\022\021\n\tstatement\030\005 \001(\t\"@\n\nActoinType\022\013\n"
    "\007kSelect\020\001\022\013\n\007kInsert\020\002\022\013\n\007kUpdate\020\003\022\013\n\007"
    "kDelete\020\004\"&\n\014DatabaseType\022\n\n\006kRedis\020\001\022\n\n"
    "\006kMySQL\020\002", 329);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "proto/dbproxy/dbproxy.Request.proto", &protobuf_RegisterTypes);
  Request::default_instance_ = new Request();
  Request::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto {
  StaticDescriptorInitializer_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto() {
    protobuf_AddDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
  }
} static_descriptor_initializer_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto_;
...
Request::Request()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:proto_dbproxy.Request)
}
...
Request::Request(const Request& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:proto_dbproxy.Request)
}
...
Request::~Request() {
  // @@protoc_insertion_point(destructor:proto_dbproxy.Request)
  SharedDtor();
}
...
const Request& Request::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:proto_dbproxy.Request)
  for (;;) {
        ...
        if (tag == 16) {
         parse_dbtype:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::proto_dbproxy::Request_DatabaseType_IsValid(value)) {
            set_dbtype(static_cast< ::proto_dbproxy::Request_DatabaseType >(value));
          } else {
        ...
        if (tag == 24) {
         parse_action:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::proto_dbproxy::Request_ActoinType_IsValid(value)) {
            set_action(static_cast< ::proto_dbproxy::Request_ActoinType >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:proto_dbproxy.Request)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:proto_dbproxy.Request)
  return false;
#undef DO_
}
...
void Request::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:proto_dbproxy.Request)
  // required uint32 identifier = 1;
  if (has_identifier()) {
  ...
  // @@protoc_insertion_point(serialize_end:proto_dbproxy.Request)
}

::google::protobuf::uint8* Request::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:proto_dbproxy.Request)
  // required uint32 identifier = 1;
  if (has_identifier()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:proto_dbproxy.Request)
  return target;
}
