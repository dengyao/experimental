...
#ifndef PROTOBUF_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto__INCLUDED
#define PROTOBUF_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto__INCLUDED
...
void  protobuf_AddDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
void protobuf_AssignDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
void protobuf_ShutdownFile_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
...
class Request : public ::google::protobuf::Message {
 public:
  ...
  // required .proto_dbproxy.Request.DatabaseType dbtype = 2;
  inline bool has_dbtype() const;
  inline void clear_dbtype();
  static const int kDbtypeFieldNumber = 2;
  inline ::proto_dbproxy::Request_DatabaseType dbtype() const;
  inline void set_dbtype(::proto_dbproxy::Request_DatabaseType value);

  // required .proto_dbproxy.Request.ActoinType action = 3;
  inline bool has_action() const;
  inline void clear_action();
  static const int kActionFieldNumber = 3;
  inline ::proto_dbproxy::Request_ActoinType action() const;
  inline void set_action(::proto_dbproxy::Request_ActoinType value);
  ...
  // @@protoc_insertion_point(class_scope:proto_dbproxy.Request)
 private:
  ...
  int action_;
  friend void  protobuf_AddDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
  friend void protobuf_AssignDesc_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
  friend void protobuf_ShutdownFile_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto();
...
inline ::google::protobuf::uint32 Request::identifier() const {
  // @@protoc_insertion_point(field_get:proto_dbproxy.Request.identifier)
  return identifier_;
}
inline void Request::set_identifier(::google::protobuf::uint32 value) {
  set_has_identifier();
  identifier_ = value;
  // @@protoc_insertion_point(field_set:proto_dbproxy.Request.identifier)
}
...
inline ::proto_dbproxy::Request_DatabaseType Request::dbtype() const {
  // @@protoc_insertion_point(field_get:proto_dbproxy.Request.dbtype)
  return static_cast< ::proto_dbproxy::Request_DatabaseType >(dbtype_);
}
inline void Request::set_dbtype(::proto_dbproxy::Request_DatabaseType value) {
  assert(::proto_dbproxy::Request_DatabaseType_IsValid(value));
  set_has_dbtype();
  dbtype_ = value;
  // @@protoc_insertion_point(field_set:proto_dbproxy.Request.dbtype)
}
...
inline ::proto_dbproxy::Request_ActoinType Request::action() const {
  // @@protoc_insertion_point(field_get:proto_dbproxy.Request.action)
  return static_cast< ::proto_dbproxy::Request_ActoinType >(action_);
}
inline void Request::set_action(::proto_dbproxy::Request_ActoinType value) {
  assert(::proto_dbproxy::Request_ActoinType_IsValid(value));
  set_has_action();
  action_ = value;
  // @@protoc_insertion_point(field_set:proto_dbproxy.Request.action)
}
...
inline const ::std::string& Request::dbname() const {
  // @@protoc_insertion_point(field_get:proto_dbproxy.Request.dbname)
  return *dbname_;
}
inline void Request::set_dbname(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:proto_dbproxy.Request.dbname)
}
inline void Request::set_dbname(const char* value) {
  ...
  dbname_->assign(value);
  // @@protoc_insertion_point(field_set_char:proto_dbproxy.Request.dbname)
}
inline void Request::set_dbname(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:proto_dbproxy.Request.dbname)
}
inline ::std::string* Request::mutable_dbname() {
  ...
  // @@protoc_insertion_point(field_mutable:proto_dbproxy.Request.dbname)
  return dbname_;
}
...
inline void Request::set_allocated_dbname(::std::string* dbname) {
  ...
  // @@protoc_insertion_point(field_set_allocated:proto_dbproxy.Request.dbname)
}
...
inline const ::std::string& Request::statement() const {
  // @@protoc_insertion_point(field_get:proto_dbproxy.Request.statement)
  return *statement_;
}
inline void Request::set_statement(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:proto_dbproxy.Request.statement)
}
inline void Request::set_statement(const char* value) {
  ...
  statement_->assign(value);
  // @@protoc_insertion_point(field_set_char:proto_dbproxy.Request.statement)
}
inline void Request::set_statement(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:proto_dbproxy.Request.statement)
}
inline ::std::string* Request::mutable_statement() {
  ...
  // @@protoc_insertion_point(field_mutable:proto_dbproxy.Request.statement)
  return statement_;
}
...
inline void Request::set_allocated_statement(::std::string* statement) {
  ...
  // @@protoc_insertion_point(field_set_allocated:proto_dbproxy.Request.statement)
}
...
template <> struct is_proto_enum< ::proto_dbproxy::Request_ActoinType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto_dbproxy::Request_ActoinType>() {
  return ::proto_dbproxy::Request_ActoinType_descriptor();
}
template <> struct is_proto_enum< ::proto_dbproxy::Request_DatabaseType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto_dbproxy::Request_DatabaseType>() {
  return ::proto_dbproxy::Request_DatabaseType_descriptor();
}
...
#endif  // PROTOBUF_proto_2fdbproxy_2fdbproxy_2eRequest_2eproto__INCLUDED
