...
class ProxyError : public ::google::protobuf::Message {
 public:
  ...
  inline ::proto_db::ProxyError_ErrorCode error_code() const;
  inline void set_error_code(::proto_db::ProxyError_ErrorCode value);
  ...
  // @@protoc_insertion_point(class_scope:proto_db.ProxyError)
 private:
  inline void set_has_error_code();
  inline void clear_has_error_code();
  inline void set_has_identifier();
...
inline ::proto_db::ProxyError_ErrorCode ProxyError::error_code() const {
  // @@protoc_insertion_point(field_get:proto_db.ProxyError.error_code)
  return static_cast< ::proto_db::ProxyError_ErrorCode >(error_code_);
}
inline void ProxyError::set_error_code(::proto_db::ProxyError_ErrorCode value) {
  assert(::proto_db::ProxyError_ErrorCode_IsValid(value));
  set_has_error_code();
  error_code_ = value;
  // @@protoc_insertion_point(field_set:proto_db.ProxyError.error_code)
}
...
inline ::google::protobuf::uint32 ProxyError::identifier() const {
  // @@protoc_insertion_point(field_get:proto_db.ProxyError.identifier)
  return identifier_;
}
inline void ProxyError::set_identifier(::google::protobuf::uint32 value) {
  set_has_identifier();
  identifier_ = value;
  // @@protoc_insertion_point(field_set:proto_db.ProxyError.identifier)
}
...
template <> struct is_proto_enum< ::proto_db::ProxyError_ErrorCode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::proto_db::ProxyError_ErrorCode>() {
  return ::proto_db::ProxyError_ErrorCode_descriptor();
}
